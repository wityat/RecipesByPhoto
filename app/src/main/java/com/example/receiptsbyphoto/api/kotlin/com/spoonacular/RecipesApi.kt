...
class RecipesApi(basePath: kotlin.String = "https://api.spoonacular.com") : ApiClient(basePath) {
    ...
    */
    ...
    @Suppress("UNCHECKED_CAST")
    fun getRecipeCard(id: kotlin.Int?) : InlineResponse20015 {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/recipes/{id}/card".replace("{"+"id"+"}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val response = request<InlineResponse20015>(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun searchRecipesByIngredients(ingredients: String?, number: Int?, limitLicense: Boolean?, ranking: Int, ignorePantry: Boolean?) : kotlin.Array<InlineResponse2001> {
        val localVariableBody: kotlin.Any? = null
