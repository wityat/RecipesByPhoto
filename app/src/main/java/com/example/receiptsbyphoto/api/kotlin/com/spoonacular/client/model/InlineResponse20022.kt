...
data class InlineResponse20022 (
    ...
    val shoppingListUnits: kotlin.Array<kotlin.String>,
    @Json(name = "aisle")
    val aisle: kotlin.String,
    @Json(name = "image")
    val image: kotlin.String,
    @Json(name = "meta")
    val meta: kotlin.Array<kotlin.Any>,
    @Json(name = "nutrition")
    val nutrition: InlineResponse20022Nutrition,
    @Json(name = "categoryPath")
    val categoryPath: kotlin.Array<kotlin.String>
) {
