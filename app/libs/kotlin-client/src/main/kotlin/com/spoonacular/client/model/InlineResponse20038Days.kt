 ...
 * @param items 
 */
data class InlineResponse20038Days (
    @Json(name = "date")
    val date: Int,
    @Json(name = "day")
    val day: kotlin.String,
    @Json(name = "nutritionSummary")
    val nutritionSummary: InlineResponse20038NutritionSummary? = null,
    @Json(name = "nutritionSummaryBreakfast")
    val nutritionSummaryBreakfast: InlineResponse20038NutritionSummary? = null,
    @Json(name = "nutritionSummaryLunch")
    val nutritionSummaryLunch: InlineResponse20038NutritionSummary? = null,
    @Json(name = "nutritionSummaryDinner")
    val nutritionSummaryDinner: InlineResponse20038NutritionSummary? = null,
    @Json(name = "items")
    val items: kotlin.Array<InlineResponse20038Items>? = null
) {
