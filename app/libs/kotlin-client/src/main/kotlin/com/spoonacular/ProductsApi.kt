...
class ProductsApi(basePath: kotlin.String = "https://api.spoonacular.com") : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getComparableProducts(upc: Float) : InlineResponse20031 {
        val localVariableBody: kotlin.Any? = null
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun productNutritionByIDImage(id: Float) : kotlin.Any {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun productNutritionLabelImage(id: Float, showOptionalNutrients: kotlin.Boolean?, showZeroValues: kotlin.Boolean?, showIngredients: kotlin.Boolean?) : kotlin.Any {
        val localVariableBody: kotlin.Any? = null
